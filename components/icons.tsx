...
export function TikTokIcon({ className = "w-5 h-5" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
      <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-2.88 2.5 2.88 2.88 0 0 1-2.88-2.88 2.89 2.89 0 0 1 2.88-2.88c.37 0 .72.07 1.05.2v-3.5a6.38 6.38 0 0 0-1.05-.09A6.33 6.33 0 0 0 3.16 15.3a6.34 6.34 0 0 0 6.33 6.34c3.49 0 6.33-2.84 6.33-6.34V8.75a8.28 8.28 0 0 0 4.84 1.54V6.85c-.37-.02-.73-.07-1.07-.16z" />
    </svg>
  );
}
